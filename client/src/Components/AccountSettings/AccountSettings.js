   ...
   <div className="account-settings">
       <div className="container">
        ...
        <div className="row">
         ...
         <div className="card custom-card  mb-3"style={{width:"auto",borderColor:"#ca3667",borderRadius:"20px" }} >
    ...
    <div className="col-lg-9 col-md-7 col-sm-12">
        <div className="custom  container p-3  " style={{ height:"auto"  ,backgroundColor:"#ffffff"}}>
      ...
      {renderSocialMediaButtons()}
          ...
          <div className="col-12">Description/Bio
            <textarea className="form-control" style={{height:"2cm"}} placeholder="Description/Bio"> </textarea>
          </div>
        </div>
       
        <div className="d-flex justify-content-end mt- "style={{marginLeft:"0cm"}}>
