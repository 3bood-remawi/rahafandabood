	...
	return (
      ...
      <div className="collaborate-info">
        ...
        <div className="info-block">
          ...
          <p className='co2'>you can search for influencers with the help of our filters to find the best content creator that suits your needs.</p>
        </div>
        <div className="info-block">
          <h3 className='co1'>Contact Influencer</h3>
          <p className='co2'>you can immediately contact influencers through our chat system.</p>
        </div>
        <div className="info-block">
          <h3 className='co1'>Collaborate!</h3>
          <p className='co2'>you can choose to collaborate with influencers and send them your offer!</p>
        </div>
      </div>
    </div>
  );
